...
A Python-based analysis of financial market microstructure using Limit Order Book (LOB) and trade tape data. Built as part of a university assessment, the project covers data extraction, visualisation, and block order detection across ~6 months of intraday market data.

## Project Structure

```
Assessment/
├── EWPY2473787/          # Main source code
...
Data files are not included in this repository due to size (~800 MB). Place them in a `DataSet01/` directory at the project root.
